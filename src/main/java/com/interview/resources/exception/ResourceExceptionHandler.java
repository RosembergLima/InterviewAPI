package com.interview.resources.exception;
...
import com.interview.services.exception.ActivedAccountException;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(ActivedAccountException.class)
	public ResponseEntity<StandardError> accountIntegrity(ActivedAccountException e, HttpServletRequest request) {
